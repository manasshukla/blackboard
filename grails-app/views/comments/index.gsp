		...
		<div id="list-comments" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="commentData" title="${message(code: 'comments.commentData.label', default: 'Comment Data')}" />
				...
				<g:each in="${commentsInstanceList}" status="i" var="commentsInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${commentsInstance.id}">${fieldValue(bean: commentsInstance, field: "commentData")}</g:link></td>
