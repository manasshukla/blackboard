		...
		<div id="list-post" class="content scaffold-list" role="main">
			...
			<thead>
					<tr><%--
						...
						--%><g:sortableColumn property="postData" title="${message(code: 'post.postData.label', default: 'Post Data')}" />
				...
				<g:each in="${postInstanceList}" status="i" var="postInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						--%><td><g:link action="show" id="${postInstance.id}">${fieldValue(bean: postInstance, field: "postData")}</g:link></td>
